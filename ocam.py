...
class v4l2_util():
    ...
    def Capability(self):
        ...
        if self.verbose:
            ...
            '  + card:', cp.card
            print
            '  + bus info:', cp.bus_info
            print
            '  + VIDEO_CAPture:', hex(cp.capabilities & v4l2.V4L2_CAP_VIDEO_CAPTURE)
            print
            '  + STREAMING', hex(cp.capabilities & v4l2.V4L2_CAP_STREAMING)
        return cp.card
    ...
    def FormatDescript(self):
        ...
        for i in range(20):  # while True:
            ...
            if self.verbose:
                ...
                print
                '  + PixelFormat:', hex(fmt.pixelformat)
    ...
    def GetFrameRate(self, pixelformat, width, height):
        ...
        for i in range(10):
            ...
            if frmival.type == v4l2.V4L2_FRMIVAL_TYPE_DISCRETE:
                ...
                print
                'todo V4L2_FRMIVAL_TYPE_CONTINUOUS'
            elif frmival.type == v4l2.V4L2_FRMIVAL_TYPE_STEPWISE:
                print
                'todo V4L2_FRMIVAL_TYPE_STEPWISE'
            else:
                print
                'todo V4L2_FRMIVAL_TYPE_*'
        return fps_list
    ...
    def SetFormat(self, form, stp):
        ...
        if self.verbose:
            ...
            '--SetFormat'
            print
            '  + set width:', form.fmt.pix.width
            print
            '  + set height:', form.fmt.pix.height
    ...
    def GetCurrentFormat(self):
        ...
        if self.verbose:
            ...
            '--GetCurrentFormat'
            print
            '  + width:', form.fmt.pix.width
            print
            '  + height:', form.fmt.pix.height
            print
            '  + pixelformat:', hex(form.fmt.pix.pixelformat)
            print
            '  + sizeimage:', form.fmt.pix.sizeimage
    ...
    def Start(self, buff_num):
        ...
        for i in range(n_buffers):
            ...
            if self.verbose:
                ...
                '--Memory MAP'
                print
                '  +MMAP:', i, buf.m.offset, buf.length
    ...
    def GetFrame(self):
        ...
        if self.verbose:
            print
            '# GetFrame:{0:.2f}ms'.format((time.time() - start_time) * 1000)
